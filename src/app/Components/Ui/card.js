...
export default function Cards(params) {
  ...
  <div className="text-center p-10">
    ...
    <h1 className="text-3xl">{params.desc}</h1>
  </div>
 ...
 <div className="w-72 bg-white shadow-md rounded-xl duration-500 hover:scale-105 hover:shadow-xl">
    ...
    <Card link="project_id" image="/kuldeep.jpeg" price="1200" total_price="1400" tags="web"/>
...
// link image tags name price total price 
function Card(params){
    ...
    <a href={`${params.link}`}>
      ...
      />
      <div className="px-4 py-3 w-72">
        <span className="text-gray-400 mr-3 uppercase text-xs">{params.tags}</span>
        <p className="text-lg font-bold text-black truncate block capitalize">
         {params.name}
        </p>
        <div className="flex items-center">
          ...
          <del>
            <p className="text-sm text-gray-600 cursor-auto ml-2">{params.total_price}</p>
          </del>
          <div className="ml-auto">
            <svg
              xmlns="http://www.w3.org/2000/svg"
